...
const POSTS_DIR = path.join(cwd, 'src/routes/font/posts/')
...
const posts = fs.readdirSync(POSTS_DIR)
  ...
  .map(fileName => {
    ...
    const { title, css, date, variants, releases, headline, sentence, paragraph, designers, foundries, socials, tags } = data
